...
import { pixelsRGBToYCbCr2, pixelsYCbCrToRGB2 } from '../misc/utilities';
...
export function App() {
  ...
  async function runModel() {
    try {
      ...
      const feeds: Record<string, ortWeb.Tensor> = {};
  ...
  async function preProcess(){
    ...
    floatPixelsY.forEach((value, index) => {
      ...
      floatPixelsY[index] = pixelsRGBToYCbCr2(red, green, blue, "y")
    })
    ...
    floatPixelsCb.forEach((value, index) => {
      ...
      floatPixelsCb[index] = pixelsRGBToYCbCr2(red, green, blue, "cb")
      floatPixelsCr[index] = pixelsRGBToYCbCr2(red, green, blue, "cr")
    })
  ...
  async function postProcess(outputArray: number []) {
    ...
    const pixel = pixelsYCbCrToRGB2(value, floatPixelsCb[index], floatPixelsCr[index])
    const currentIndex = index * 4;
